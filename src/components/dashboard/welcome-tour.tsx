...
const STEPS = [
  ...
  {
    title: "Navigation",
    body: "Use the bar at the bottom to switch between Dashboard, Companies, Retailers, Invoices, Payments, and Credit Note. On larger screens, the same links appear in the left sidebar. Open your profile from the avatar for account actions.",
